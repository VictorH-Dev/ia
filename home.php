...
class="d-flex
  ...
  <div class="profile-container">
    ...
    <img src="uploads/perfis/<?=$user['p_p']?>" class="w-25 rounded-circle">
  ...
  <a href="logout.php" class="btn btn-dark">Sair</a>
		...
		<!-- Adicione este código no local apropriado dentro do seu arquivo home.php -->
<div class="container">
    <a href="grupos.php" class="btn btn-primary" style="text-decoration: none; color: white; padding: 10px 20px; background-color: #007bff; border-radius: 5px; border: none; font-size: 16px; cursor: pointer; display: inline-block; margin-top: 20px;">
        Ver Grupos
    </a>
</div>
    </div>
